 ...
 */
public class AddInventoryMemberController implements Initializable {
    ...
    public void actionAddInventoryMember(ActionEvent actionEvent) {
        ...
        if(checkFill()){
            ...
            try {
                ...
                insert.setInt(1,AddMemberController.id);
                ...
                AddMemberController.dataInventory.add(new TableInventory(tfInventoryMemberName.getText(),AddMemberController.id,Integer.parseInt(tfInventoryMemberQuantity.getText()),taInventoryMemberInfo.getText()));

                Stage stage = (Stage) tfInventoryMemberName.getScene().getWindow();
                createScene.setPrevStage(stage);
                createScene.swapScene("/Windows/AddInventoryMemberWindow.fxml","Dodaj wyposażenie członka");
